...
async function main() {
    ...
    try {
        ...
        console.log(`✨ Stats updated: 18,500 XP (Elite), 5 Week Streak (Iron Runner)`);
        ...
        const rewardsToCreate = [
            {
                ...
                description: 'First place finish in the weekly Morning Sprinters challenge!',
            },
            {
            ...
            },
            {
                ...
                description: '30-day running consistency — 4 consecutive weeks of running!',
            },
        ];
