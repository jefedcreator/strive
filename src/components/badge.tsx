...
export const BadgeIcons = {
  ...
  Star: (props: any) => (
    <svg
      ...
      {...props}
    >
      <path d="m8.85 16.825l3.15-1.9l3.15 1.925l-.825-3.6l2.775-2.4l-3.65-.325l-1.45-3.4l-1.45 3.375l-3.65.325l2.775 2.425zM5.825 21l1.625-7.025L2 9.25l7.2-.625L12 2l2.8 6.625l7.2.625l-5.45 4.725L18.175 21L12 17.275zM12 12.25" />
    </svg>
  ),
  //   Sparkles: (props: any) => (
  //     <svg
...
export const variantStyles = {
  gold: {
    ...
    satoriGradient:
      'linear-gradient(135deg, #FFD02D 0%, #E39D00 50%, #B86B00 100%)',
  ...
  club: {
    ...
    satoriGradient:
      'linear-gradient(135deg, #3b82f6 0%, #8b5cf6 50%, #4c1d95 100%)',
    glow: 'bg-blue-500/20',
...
export function Badge({ variant, className = '', labelOverride }: BadgeProps) {
  ...
  return (
    <div
      className={`relative w-full max-w-[320px] aspect-square group ${className}`}
    >
      {/* Glow effect */}
      <div
      ...
      <div
        className={`absolute top-0 right-4 animate-bounce ${styles.decorations}`}
      >
