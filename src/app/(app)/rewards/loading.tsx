        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mb-8 md:mb-10">
          ...
          <div className="md:col-span-2 grid grid-cols-2 gap-3 md:gap-4">
            {[...Array(4)].map((_, i) => (
              <div
                key={i}
                className="bg-card-light dark:bg-card-dark rounded-2xl border border-gray-200 dark:border-gray-800 p-4 md:p-6 space-y-3"
              >
          ...
          <div className="flex items-center gap-4">
            {[...Array(5)].map((_, i) => (
              ...
              >
                ...
                <Skeleton className="h-2.5 md:h-3 w-10 md:w-12" />
                <Skeleton className="h-1.5 md:h-2 w-12 md:w-16" />
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-2 xl:grid-cols-3 gap-3 md:gap-6">
            {[...Array(3)].map((_, i) => (
              <div
                key={i}
                className="rounded-2xl border border-gray-100 dark:border-gray-800 p-1 space-y-3"
              >
