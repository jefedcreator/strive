      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          >
            ...
            <span className="font-extrabold text-2xl tracking-tighter text-gray-900 dark:text-white">STRIVE</span>
          </motion.div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <span className="relative inline-block">
            ...
            <span className="relative text-transparent bg-clip-text bg-gradient-to-r from-primary via-[#ff6a00] to-orange-400">Conquer.</span>
          </span>
        </motion.h1>
        ...
        >
          Your fitness journey, unified. Automatically sync activities from <strong className="text-gray-900 dark:text-gray-200 font-bold">Strava</strong> and <strong className="text-gray-900 dark:text-gray-200 font-bold">NRC</strong> to unlock global leaderboards, private clubs, and detailed analytics.
        </motion.p>
        ...
        >
          ...
          >
            <div className="relative rounded-[2rem] overflow-hidden bg-gray-50 dark:bg-[#0B0F19] border border-gray-200/50 dark:border-white/5 ring-1 ring-black/5 dark:ring-white/10">
              <img alt="Strive Dashboard Interface" className="w-full h-auto object-cover block dark:hidden opacity-95 group-hover:opacity-100 transition-opacity duration-700" src="/sample.webp" />
              <img alt="Strive Dashboard Interface Dark Mode" className="w-full h-auto object-cover hidden dark:block opacity-90 group-hover:opacity-100 transition-opacity duration-700" src="/sample.webp" />
          ...
          >
            <div className="bg-white/90 dark:bg-black/80 backdrop-blur-xl p-4 md:p-5 rounded-2xl shadow-xl border border-black/5 dark:border-white/10 flex items-center gap-4 filter drop-shadow-[0_10px_20px_rgba(0,0,0,0.1)]">
              ...
              <div>
                <p className="text-xs uppercase tracking-wider text-gray-500 dark:text-gray-400 font-bold mb-0.5">Global Rank</p>
                <p className="text-xl font-black text-gray-900 dark:text-white tracking-tight">Top 5%</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="bg-white/90 dark:bg-black/80 backdrop-blur-xl p-4 md:p-5 rounded-2xl shadow-xl border border-black/5 dark:border-white/10 flex items-center gap-4 filter drop-shadow-[0_10px_20px_rgba(0,0,0,0.1)]">
              ...
              <div>
                <p className="text-xs uppercase tracking-wider text-gray-500 dark:text-gray-400 font-bold mb-0.5">Weekly Mileage</p>
                <div className="flex items-baseline gap-1">
                  <p className="text-xl font-black text-gray-900 dark:text-white tracking-tight">42.5</p>
    ...
    <section className="py-16 bg-white dark:bg-[#06080D] border-y border-gray-100 dark:border-white/5 relative z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center items-center gap-16 md:gap-24">
          ...
          >
            <span className="text-3xl font-black font-sans text-[#fc4c02] tracking-tighter">STRAVA</span>
          </motion.div>
          <motion.div 
            whileHover={{ scale: 1.05, filter: "grayscale(0%) opacity(1)" }}
            className="flex items-center gap-2 grayscale opacity-50 dark:opacity-40 transition-all duration-300 cursor-pointer"
          >
            <span className="text-3xl font-black font-sans italic text-black dark:text-white tracking-widest style-nrc">NRC</span>
          </motion.div>
        </div>
      </div>
    </section>
...
function Capabilities() {
  ...
  // Card 1
  const card1X = useTransform(scrollYProgress, [0, 0.16, 0.33], ["0vw", "40vw", "0vw"]);
  const card1Rotate = useTransform(scrollYProgress, [0, 0.16, 0.33], [0, 15, 0]);
  ...
  // Card 2
  const card2X = useTransform(scrollYProgress, [0, 0.33, 0.5, 0.66], ["0vw", "0vw", "40vw", "0vw"]);
  const card2Rotate = useTransform(scrollYProgress, [0, 0.33, 0.5, 0.66], [0, 0, 15, 0]);
  const card2Y = useTransform(scrollYProgress, [0, 0.33, 0.66], ["5vh", "0vh", "5vh"]);
  const card2Scale = useTransform(scrollYProgress, [0, 0.33, 0.66], [0.95, 1, 0.9]);
  const card2Z = useTransform(scrollYProgress, [0, 0.33, 0.43, 0.66], [30, 40, 39, 10]);
  const card2Opacity = useTransform(scrollYProgress, [0, 0.33, 0.66], [0.8, 1, 0.5]);

  // Card 3
  const card3X = useTransform(scrollYProgress, [0, 0.66, 0.83, 1], ["0vw", "0vw", "40vw", "0vw"]);
  const card3Rotate = useTransform(scrollYProgress, [0, 0.66, 0.83, 1], [0, 0, 15, 0]);
  const card3Y = useTransform(scrollYProgress, [0, 0.33, 0.66, 1], ["10vh", "5vh", "0vh", "5vh"]);
  const card3Scale = useTransform(scrollYProgress, [0, 0.33, 0.66, 1], [0.9, 0.95, 1, 0.9]);
  const card3Z = useTransform(scrollYProgress, [0, 0.33, 0.66, 0.76, 1], [20, 30, 40, 39, 10]);
  const card3Opacity = useTransform(scrollYProgress, [0, 0.33, 0.66, 1], [0.6, 0.8, 1, 0.5]);

  // Card 4 (Never gets flicked to the back as it's the last one)
  const card4Y = useTransform(scrollYProgress, [0, 0.33, 0.66, 1], ["15vh", "10vh", "5vh", "0vh"]);
  const card4Scale = useTransform(scrollYProgress, [0, 0.33, 0.66, 1], [0.85, 0.9, 0.95, 1]);
  const card4Z = useTransform(scrollYProgress, [0, 0.33, 0.66, 1], [10, 20, 30, 40]);
  const card4Opacity = useTransform(scrollYProgress, [0, 0.33, 0.66, 1], [0.4, 0.6, 0.8, 1]);

  return (
    <section className="py-24 md:py-32 bg-background-light dark:bg-[#0B0F19] relative" id="features">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full relative">
        <div className="text-center max-w-3xl mx-auto mb-16 md:mb-20">
          ...
          >
            Everything you need to <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-orange-400">level up.</span>
          </motion.p>
          <motion.p 
            initial={{ opacity: 0, y: 10 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            Strive bridges the gap between platforms, bringing all your fitness data into one cohesive ecosystem.
          </motion.p>
        </div>
        
        {/* Mobile 3D Scroll Stacking */}
        <div ref={mobileRef} className="md:hidden h-[400vh] relative w-full -mx-4 px-4 overflow-visible">
          <div className="sticky top-0 h-screen flex flex-col items-center justify-center overflow-visible w-full relative">
            
            <motion.div style={{ x: card1X, y: card1Y, rotate: card1Rotate, scale: card1Scale, opacity: card1Opacity, zIndex: card1Z, transformOrigin: "top center" }} className="absolute w-full px-4">
               <div className="p-8 bg-white dark:bg-[#121826] rounded-[2rem] border border-gray-100 dark:border-white/5 shadow-2xl">
                ...
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white">Multi-Platform Sync</h3>
                </div>
                <p className="text-gray-500 dark:text-gray-400 leading-relaxed font-medium">
                  Connect Strava and Nike Run Club accounts simultaneously. No more manual entry.
                </p>
              </div>
            </motion.div>

            <motion.div style={{ x: card2X, y: card2Y, rotate: card2Rotate, scale: card2Scale, opacity: card2Opacity, zIndex: card2Z, transformOrigin: "top center" }} className="absolute w-full px-4">
               <div className="p-8 bg-white dark:bg-[#121826] rounded-[2rem] border border-gray-100 dark:border-white/5 shadow-[0_-5px_20px_-10px_rgba(0,0,0,0.1)]">
                ...
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white">Global Leaderboards</h3>
                </div>
                <p className="text-gray-500 dark:text-gray-400 leading-relaxed font-medium">
                  See where you stand against runners worldwide, regardless of which app they use.
                </p>
              </div>
            </motion.div>

            <motion.div style={{ x: card3X, y: card3Y, rotate: card3Rotate, scale: card3Scale, opacity: card3Opacity, zIndex: card3Z, transformOrigin: "top center" }} className="absolute w-full px-4">
              <div className="p-8 bg-white dark:bg-[#121826] rounded-[2rem] border border-gray-100 dark:border-white/5 shadow-[0_-5px_20px_-10px_rgba(0,0,0,0.1)]">
                ...
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white">Private Clubs</h3>
                </div>
                <p className="text-gray-500 dark:text-gray-400 leading-relaxed font-medium">
                  Create exclusive groups for friends, companies, or run clubs with custom challenges.
                </p>
              </div>
            </motion.div>

            <motion.div style={{ y: card4Y, scale: card4Scale, opacity: card4Opacity, zIndex: card4Z, transformOrigin: "top center" }} className="absolute w-full px-4">
               <div className="p-8 bg-white dark:bg-[#121826] rounded-[2rem] border border-gray-100 dark:border-white/5 shadow-[0_-5px_20px_-10px_rgba(0,0,0,0.1)]">
                ...
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white">Detailed Analytics</h3>
                </div>
                <p className="text-gray-500 dark:text-gray-400 leading-relaxed font-medium">
                  Deep dive into your performance trends with aggregated data visualization.
                </p>
              </div>
            </motion.div>
        ...
        >
          <motion.div variants={item} whileHover={{ y: -8 }} className="group relative p-8 bg-white dark:bg-[#121826] rounded-[2rem] border border-gray-100 dark:border-white/5 transition-all duration-300 hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05)] dark:hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.3)]">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Multi-Platform Sync</h3>
            <p className="text-gray-500 dark:text-gray-400 leading-relaxed font-medium">
              Connect Strava and Nike Run Club accounts simultaneously. No more manual entry.
            </p>
          </motion.div>
          ...
          <motion.div variants={item} whileHover={{ y: -8 }} className="group relative p-8 bg-white dark:bg-[#121826] rounded-[2rem] border border-gray-100 dark:border-white/5 transition-all duration-300 hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05)] dark:hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.3)]">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Global Leaderboards</h3>
            <p className="text-gray-500 dark:text-gray-400 leading-relaxed font-medium">
              See where you stand against runners worldwide, regardless of which app they use.
            </p>
          </motion.div>
          ...
          <motion.div variants={item} whileHover={{ y: -8 }} className="group relative p-8 bg-white dark:bg-[#121826] rounded-[2rem] border border-gray-100 dark:border-white/5 transition-all duration-300 hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05)] dark:hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.3)]">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Private Clubs</h3>
            <p className="text-gray-500 dark:text-gray-400 leading-relaxed font-medium">
              Create exclusive groups for friends, companies, or run clubs with custom challenges.
            </p>
          </motion.div>
...
function LeaderboardSection() {
  const containerVariants = {
    hidden: { opacity: 0 },
    show: { opacity: 1, transition: { staggerChildren: 0.1, delayChildren: 0.3 } as any }
  };
  ...
  return (
    <section className="py-32 overflow-hidden bg-white dark:bg-[#06080D] relative" id="leaderboards">
      {/* Decorative Blur */}
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
            ...
            >
              <div className="p-8">
                <div className="flex justify-between items-center mb-8">
                  <h4 className="font-extrabold text-xl text-gray-900 dark:text-white tracking-tight">Weekly Distance</h4>
                  <span className="text-xs text-primary font-bold cursor-pointer hover:text-[#e04000] flex items-center gap-1 group transition-colors">
                    View Full <ArrowRight className="w-3 h-3 group-hover:translate-x-0.5 transition-transform" />
                  </span>
                </div>
                ...
                >
                  {[
                    { rank: 1, initials: 'JM', name: 'James M.', distance: '84.5', color: 'text-yellow-700 bg-yellow-100', avatarBg: 'bg-yellow-500/10' },
                    { rank: 2, initials: 'SJ', name: 'Sarah J.', distance: '72.1', color: 'text-pink-600 bg-pink-100', avatarBg: 'bg-pink-500/10' },
                    { rank: 3, initials: 'R',  name: 'You',      distance: '68.4', color: 'text-primary bg-primary/10', avatarBg: 'bg-primary/5', highlight: true }
                  ].map((user, idx) => (
                    <motion.div 
                      key={idx}
                    ...
                    >
                      <div className="flex items-center gap-4">
                        <div className={`w-10 h-10 rounded-xl ${user.color} flex items-center justify-center font-black text-sm shadow-sm`}>
                          {user.rank}
                        </div>
                        <div className={`w-10 h-10 rounded-full ${user.avatarBg} text-gray-700 dark:text-gray-300 flex items-center justify-center font-bold text-sm border border-black/5 dark:border-white/10`}>
                          {user.initials}
                        </div>
                        <span className={`font-bold text-base ${user.highlight ? 'text-primary' : 'text-gray-900 dark:text-white'}`}>{user.name}</span>
                      </div>
                      <div className="flex flex-col items-end">
                        <span className="font-black text-lg text-gray-900 dark:text-white tracking-tight">{user.distance}</span>
          ...
          >
            <h2 className="text-4xl md:text-5xl font-black tracking-tight text-gray-900 dark:text-white mb-6 leading-tight">
              Compete on a <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-purple-500">Level Playing Field.</span>
            </h2>
            <p className="text-xl text-gray-600 dark:text-gray-400 mb-10 leading-relaxed font-medium">
              It doesn't matter if your friends use different apps. Strive normalizes the data to create fair, engaging leaderboards. Track distance, elevation, pace, and consistency across your entire network.
            </p>
            <ul className="space-y-6">
              {[
                ...
                >
                  ...
                  <span className="text-lg font-bold text-gray-800 dark:text-gray-200 mt-0.5">{item}</span>
                </motion.li>
              ))}
            </ul>
          </motion.div>
...
function CTA() {
  return (
    <section className="py-32 relative overflow-hidden bg-white dark:bg-[#06080D]" id="clubs">
      {/* Dynamic Background */}
      ...
      >
        <div className="bg-white/80 dark:bg-[#121826]/80 backdrop-blur-2xl rounded-[3rem] p-10 md:p-20 text-center border border-white/50 dark:border-white/10 shadow-[0_30px_60px_-15px_rgba(252,76,2,0.1)]">
          ...
          <h2 className="text-5xl font-black tracking-tight text-gray-900 dark:text-white mb-6 leading-tight">Ready to unite your <br className="hidden md:block"/> running life?</h2>
          <p className="text-xl text-gray-600 dark:text-gray-400 mb-12 max-w-2xl mx-auto font-medium">Join thousands of runners who have already synced over 1 million kilometers on Strive.</p>
          ...
          <p className="mt-8 text-sm font-bold text-gray-400 uppercase tracking-widest">No credit card required</p>
        </div>
      </motion.div>
    </section>
  );
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-2 mb-4 group cursor-pointer">
              ...
              <span className="font-extrabold tracking-tighter text-xl text-gray-900 dark:text-white">STRIVE</span>
            </div>
            <p className="text-sm text-gray-500 dark:text-gray-400 mb-6 font-medium leading-relaxed">
              The ultimate dashboard for the modern social athlete. Connect, compete, and analyze.
            </p>
            <div className="flex gap-4">
              <a className="text-gray-400 hover:text-primary dark:hover:text-primary transition-colors" href="#"><Twitter className="w-5 h-5" /></a>
              <a className="text-gray-400 hover:text-primary dark:hover:text-primary transition-colors" href="#"><Instagram className="w-5 h-5" /></a>
              <a className="text-gray-400 hover:text-primary dark:hover:text-primary transition-colors" href="#"><Github className="w-5 h-5" /></a>
            </div>
          </div>
          <div>
            <h4 className="font-bold text-gray-900 dark:text-gray-200 mb-4 tracking-tight">Product</h4>
            <ul className="space-y-3 text-sm font-medium text-gray-500 dark:text-gray-400">
              <li><a className="hover:text-primary dark:hover:text-gray-200 transition-colors" href="#">Features</a></li>
              <li><a className="hover:text-primary dark:hover:text-gray-200 transition-colors" href="#">Integrations</a></li>
              <li><a className="hover:text-primary dark:hover:text-gray-200 transition-colors" href="#">Pricing</a></li>
              <li><a className="hover:text-primary dark:hover:text-gray-200 transition-colors" href="#">Roadmap</a></li>
            </ul>
          </div>
          <div>
            <h4 className="font-bold text-gray-900 dark:text-gray-200 mb-4 tracking-tight">Resources</h4>
            <ul className="space-y-3 text-sm font-medium text-gray-500 dark:text-gray-400">
              <li><a className="hover:text-primary dark:hover:text-gray-200 transition-colors" href="#">Blog</a></li>
              <li><a className="hover:text-primary dark:hover:text-gray-200 transition-colors" href="#">Help Center</a></li>
              <li><a className="hover:text-primary dark:hover:text-gray-200 transition-colors" href="#">API Docs</a></li>
              <li><a className="hover:text-primary dark:hover:text-gray-200 transition-colors" href="#">Community</a></li>
            </ul>
          </div>
          <div>
            <h4 className="font-bold text-gray-900 dark:text-gray-200 mb-4 tracking-tight">Legal</h4>
            <ul className="space-y-3 text-sm font-medium text-gray-500 dark:text-gray-400">
              <li><a className="hover:text-primary dark:hover:text-gray-200 transition-colors" href="#">Privacy Policy</a></li>
              <li><a className="hover:text-primary dark:hover:text-gray-200 transition-colors" href="#">Terms of Service</a></li>
              <li><a className="hover:text-primary dark:hover:text-gray-200 transition-colors" href="#">Cookie Policy</a></li>
            </ul>
          </div>
        </div>
