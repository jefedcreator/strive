...
export class PuppeteerService {
    private readonly DEFAULT_CHROME_PATH = "/Applications/Google Chrome.app/Contents/MacOS/Google Chrome";
    ...
    async captureNikeAuth(options: CaptureOptions = {}): Promise<NikeAuthResult> {
        ...
        try {
            ...
            await page.waitForSelector(this.SELECTORS.EMAIL_INPUT, { visible: true, timeout: 60000 });
            ...
            await page.goto(this.URLS.PROFILE, { waitUntil: 'networkidle2', timeout });

            // --- 7. EXTRACT USERNAME ---
            console.log('👀 Waiting for username...');
            await page.waitForSelector(this.SELECTORS.USERNAME, { visible: true, timeout });
